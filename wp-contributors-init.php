...
// Bail if we're doing an auto save
  ...
  if( !current_user_can( 'edit_post' ) ) return;
    ...
    function wpi_display_meta($content) {
$custom_meta=array();
global $post;
...
function wpi_author_display_block($custom_meta)
{
if (!empty($custom_meta)) {
            $author="";
    ...
    public function wpi_register_plugin_styles() {
        wp_register_style('wordpress-contributors-boot', plugins_url('wordpress-contributors/css/bootstrap.min.css'));
        wp_enqueue_style('wordpress-contributors-boot');
